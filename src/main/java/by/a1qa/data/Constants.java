...
public class Constants {
    ...
    public static final String fourthTitle = "Find great shows near you.";
    public static final String fifthTitle = "Join us!";
    public static final String cityName = "London";
    public static final String holdTimerTxt = "We've held your tickets for  ";
}
